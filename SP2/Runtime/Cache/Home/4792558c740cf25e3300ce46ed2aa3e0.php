...
<?php if(($langs) == "en"): ?><div class="we wd1024 nav-header">
    ...
    <div>
        <img src="/sp2/Application/Home/View/default/Static/caow/img/1.jpg"style="display:block;" width="100%;"alt="">
    </div>
<!-- 第二块 -->
    <div class="paodu wd1024">
        <div class="paoduy ">产品中心</div>
        <div class="paoduyy">PRODUCT CENTER</div>
    </div>
    <!-- 三-->
    
    <div class="ption">
        <div class="ption2 wd1024">
            <?php if(is_array($first_list)): $i = 0; $__LIST__ = $first_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="ption1 "><a class="product-a active" href="<?php echo U('products', ['product_cate_id' => $vo['id']]);?>"><?php echo ($vo["title"]); ?></a></div><?php endforeach; endif; else: echo "" ;endif; ?>
            <div style="clear:both;"></div>
        </div>
    </div> 
    <div class="back products">   
        <div class="ji"></div> 
        <!-- 第四块 -->
        <div class="bar0 wd1024">
            <?php if(is_array($products)): $i = 0; $__LIST__ = $products;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="photo_frame">
                <div class="product-item">
                    <a href="<?php echo U('product_detail', ['id' => $vo['id']]);?>">
                    <div class="photo_frame1"><img src="<?php echo ($vo["cover_img"]); ?>" alt=""></div>
                    <div class="font_sizee">
                        <?php if(($langs) == "zh"): ?><div class="pro-title"><?php echo ($vo["title"]); ?></div><?php endif; ?>
                        <?php if(($langs) == "en"): ?><div class="pro-title"><?php echo ($vo["en_title"]); ?></div><?php endif; ?>
                        <!-- <div class="pro-category">槽王开槽机</div>
                        <div style="clear:both;"></div> -->
                    </div>
                    </a>
                </div>

...
<div class="news-nav poa z2">
		<ul>
			<li><a href="<?php echo U('Index/news_list');?>" class="cur">全部</a></li>
					...
					<li><a href="<?php echo U('Index/news_3');?>" class='cur'>品牌活动</a></li>
				</ul>
	</div>	
		...
		<ul>
			<li >
				<div class="detail poa z2  ">
					<div class="in por">
						...
						<a href="<?php echo U('Index/news_5');?>">
							<p class="t">“月亮[bǐng]，代表我的心”与“她们…</p>
							<p>爱心如月，守望真心！感谢大家的热情参与，本次“月亮[bǐng]，代表我的心——比比谁画的月饼圆”…</p>
						</a>
					</div>
				...
				<div class="img fr por ovh">
					<a href="<?php echo U('Index/news_5');?>"><img src="/matai/Application/Home/View/default/Static/matai/upload/2016/09/23/147460775603pj6jv.gif" alt="“月亮[bǐng]，代表我的心”与“她们的故事……”获奖名单公布" width="100%" class="scale">
					</a>
				</div>
			</li>
		</ul>

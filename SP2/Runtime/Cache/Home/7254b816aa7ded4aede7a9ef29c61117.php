...
<div class="news-nav poa z2">
		<ul>
			...
			<li><a href="<?php echo U('Index/news_2');?>" class='cur'>搭配推荐</a></li>
		...
		<ul>
			<li >
				<div class="detail poa z2  ">
					<div class="in por">
						<p class="time">2016/12/30</p>
						<a href="<?php echo U('Index/news_5');?>">
							<p class="t">元旦，dunnu邀你一起玩转“领”域！</p>
							<p>元旦特别推荐不知从何时起在这个说冷不冷的季节里披着“毯子”出街成为一股新潮流，街拍达人基本…</p>
						</a>
					</div>
				...
				<div class="img fr por ovh">
					<a href="<?php echo U('Index/news_5');?>"><img src="/matai/Application/Home/View/default/Static/matai/upload/2016/12/30/148308446885cekm8.jpg" alt="元旦，dunnu邀你一起玩转“领”域！" width="100%" class="scale">
					</a>
				</div>
			</li>	
		</ul>
...
<script src="/matai/Application/Home/View/default/Static/matai/static/web/js/maind7f1.js?v=v2" type="text/javascript" charset="utf-8"></script><script>
$(function(){

...
<div class="series-nav poa z2">
		<ul>
			<li >
				<a href="<?php echo U('Index/product_list');?>" class="tit">2017</a>
	...
	<div class="inside-wrap por h-t">
		...
		<div class="series-box por ovh f-cb">
            <div class="box por ovh fl">
                <a href="<?php echo U('product_list_2');?>" class="imgshow">
                    <img src="/matai/Application/Home/View/default/Static/matai/upload/2015/12/31/145155168016uybtl.jpg" width="100%" alt="" class="scale">
                    <span class="bg poa-f dn"></span>
                    <span class="sign poa">
                        <span class="line t poa"></span>
                        <span>Read more</span>
            ...
            <div class="tips l25 poa">
                <div class="tips-in tips-detail">
                    <div class="in por">
                        <p class="year">2016</p>
                        <a href="<?php echo U('product_list_2');?>" class="t">春</a>
                        <div class="line poa"></div>
                        <a href="<?php echo U('product_list_2');?>" class="more-btn por ovh">
                            <span>Read more</span>
                            <span class="blank poa-f"></span>
                ...
                <div class="tips-in por ovh">
                    <a href="<?php echo U('product_list_2');?>" class="imgshow">
                        <img src="/matai/Application/Home/View/default/Static/matai/upload/2016/01/02/145170148961ufn8a.jpg" width="100%" alt="" class="scale">
                        <span class="bg poa-f dn"></span>
                        <span class="sign poa">
                            <span class="line t poa"></span>
                            <span>Read more</span>
            ...
            <div class="tips ml fl">
                <div class="tips-in por ovh">
                    <a href="<?php echo U('product_list_2');?>" class="imgshow">
                        <img src="/matai/Application/Home/View/default/Static/matai/upload/2016/01/02/145170148992ufn8a.jpg" width="100%" alt="" class="scale">
                        <span class="bg poa-f dn"></span>
                        <span class="sign poa">
                            <span class="line t poa"></span>
                            <span>Read more</span>
                ...
                <div class="tips-in por ovh">
                    <a href="<?php echo U('product_list_2');?>" class="imgshow">
                        <img src="/matai/Application/Home/View/default/Static/matai/upload/2015/12/31/145155168015uybtl.jpg" width="100%" alt="" class="scale">
                        <span class="bg poa-f dn"></span>
                        <span class="sign poa">
                            <span class="line t poa"></span>
                            <span>Read more</span>
            ...
            <div class="tips fl">
                <div class="tips-in por ovh">
                    <a href="<?php echo U('product_list_2');?>" class="imgshow">
                        <img src="/matai/Application/Home/View/default/Static/matai/upload/2015/12/31/145155168018uybtl.jpg" width="100%" alt="" class="scale">
                        <span class="bg poa-f dn"></span>
                        <span class="sign poa">
                            <span class="line t poa"></span>
                            <span>Read more</span>
                ...
                <div class="tips-in por ovh">
                    <a href="<?php echo U('product_list_2');?>" class="imgshow">
                        <img src="/matai/Application/Home/View/default/Static/matai/upload/2016/01/02/145172088022r27sg.jpg" width="100%" alt="" class="scale">
                        <span class="bg poa-f dn"></span>
                        <span class="sign poa">
                            <span class="line t poa"></span>
                            <span>Read more</span>

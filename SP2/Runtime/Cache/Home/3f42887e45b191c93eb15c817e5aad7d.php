                                        ...
                                        <div class="shop-tab">
                                            ...
                                            <div class="col-md-4 col-lg-4 col-sm-6">
                                                <div class="single-product s-res s-non">
                                                    <div class="product-img">
                                                        <a href="<?php echo U('Index/pro_detail');?>">
                                                            <img src="/zuoqi/Application/Home/View/default/Static/zuoqi/img/products/3.jpg" alt="产品名称" />
                                                        </a>
                                                    </div>
                                                    <div class="product-dsc">
                                                        <h3><a href="<?php echo U('Index/pro_detail');?>">产品名称</a></h3>
                                            ...
                                            <div class="col-md-4 col-lg-4 col-sm-6">
                                                <div class="single-product s-res sha">
                                                    <div class="product-img">
                                                        <a href="<?php echo U('Index/pro_detail');?>">
                                                            <img src="/zuoqi/Application/Home/View/default/Static/zuoqi/img/products/5.jpg" alt="产品名称" />
                                                        </a>
                                                    </div>
                                                    <div class="product-dsc">
                                                        <h3><a href="<?php echo U('Index/pro_detail');?>">产品名称</a></h3>

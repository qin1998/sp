...
<?php if(($langs) == "en"): ?><div class="we wd1024 nav-header">
      ...
      <div class="m-btn fr">
       ...
       <div><img src="/sp2/Application/Home/View/default/Static/caow/img/1.jpg" style="width:100%;" alt=""></div> 
<div class="xinrun">
      <div class="xinrun2">
            <div class="About_text">ABOUT SNBON</div>
            <div class="AboutSlot_english">COMPANY PROFLE</div>
      </div>
      <div class="below_la1 wd1024"></div>
...
<div class="Main-Items">
     <div  class="mai-ite1"><img src="/sp2/Application/Home/View/default/Static/caow/img/介绍_04.png" alt=""></div>
</div>

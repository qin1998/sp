...
<!-- 第二块 -->
    <div class="paodu">
        <div class="paoduy">新闻详情</div>
        <div class="paoduyy">NEWS DETAIL</div>
        <div class="jiu"></div>
    </div>
    <div class="product-detail">   
            <?php if(($langs) == "zh"): ?><div class="product-title"><?php echo ($news_detail["title"]); ?></div>
        <div class="product-content"><?php echo ($news_detail["content"]); ?></div><?php endif; ?>
        <?php if(($langs) == "en"): ?><div class="product-title"><?php echo ($news_detail["en_title"]); ?></div>
            <div class="product-content"><?php echo ($news_detail["en_content"]); ?></div><?php endif; ?>
    </div>

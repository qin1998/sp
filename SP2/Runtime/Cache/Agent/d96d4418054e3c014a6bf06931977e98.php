              ...
              <ul class="nav sidebar-inner">
                  <li  class="has-sub" >
                    <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#dashboard"
                      ...
                      <span class="nav-text">lalal</span> <b class="caret"></b>
                    </a>
                    <ul class="collapse"
                      ...
                      <div class="sub-menu">
                          ...
                          <li >
                            <a class="sidenav-item-link" href="<?php echo U('Index/user_index');?>">
          ...
          <table class="table card-table table-responsive table-responsive-large" style="width:100%">
            ...
            <tbody>
                <?php if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td ><img src="<?php echo ($vo["avatarimg"]); ?>" style="width: 50px;" /></td>
                    <td >
                      <?php echo ($vo["sex"]); ?>
                    </td>
                    <td class="d-none d-md-table-cell"><?php echo ($vo["age"]); ?></td>
                    <td class="d-none d-md-table-cell"><?php echo ($vo["date"]); ?></td>
                    <td class="d-none d-md-table-cell"><?php echo ($vo["height_index + 70"]); ?>cm</td>
                    <td class="d-none d-md-table-cell"><?php echo ($vo["health_count"]); ?></td>
                    <td class="text-right">
                      <div class="dropdown show d-inline-block widget-dropdown">
                        <a class="dropdown-toggle icon-burger-mini" href="" role="button" id="dropdown-recent-order1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-display="static"></a>
                        <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown-recent-order1">
                          <li class="dropdown-item">
                            <a href="<?php echo U('health_index', ['mall_user_id' => $vo['mall_user_id'],'role_id' => $vo['id']]);?>">健康管理</a>
                          </li>
                        </ul>
                      </div>
                    </td>

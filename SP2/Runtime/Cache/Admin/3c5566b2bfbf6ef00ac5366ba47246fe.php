...
<html lang="en">
    <head>
        <meta charset="UTF-8">
        <title>欢迎您登录<?php echo C('WEB_SITE_TITLE');?>后台管理系统</title>
        <link rel="stylesheet" type="text/css" href="/matai/Public/Admin/css/login.css" media="all">
    ...
    <body id="login-page">
            ...
            <div class="login-body">
                <div class="login-main pr">
                    <form action="<?php echo U('login');?>" method="post" class="login-form">
                        <h3 class="welcome">
                            <?php if(C('WEB_SITE_LOGO_DEEP')): ?>
                                <img class="login-logo" src="<?php echo (get_cover(C("WEB_SITE_LOGO"),'path')); ?>">
                            <?php else: ?>
     ...
     <!--[if lt IE 9]>
    <script type="text/javascript" src="/matai/Public/static/jquery/jquery-1.11.1.min.js"></script>
    <![endif]--><!--[if gte IE 9]><!-->
    <script type="text/javascript" src="/matai/Public/static/jquery/jquery-2.1.1.min.js"></script>
    <!--<![endif]-->

...
return array(
    ...
    'MODULE_ALLOW_LIST'  => array('Home','Admin','Install','Agent'),

    /* 系统数据加密设置 */
    'DATA_AUTH_KEY' => 'o4d&wctIl@.aAY|<kRQzZsC~G0m%F+!Ti1g,H^>b', //默认数据加密KEY
    ...
    'DOWNLOAD_UPLOAD' => array(
        ...
        'exts'     => 'jpg,gif,png,jpeg,zip,rar,tar,gz,7z,doc,docx,txt,xml,xls,xlsx,ppt,pptx,pdf', //允许上传的文件后缀

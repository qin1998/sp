...
function register_administrator($db, $prefix, $admin, $auth){
    show_msg('开始注册创始人帐号...');
    $sql = "DELETE FROM {$prefix}ucenter_member;" .
           "ALTER TABLE {$prefix}ucenter_member AUTO_INCREMENT = 1;" .
           "INSERT INTO `[PREFIX]ucenter_member` VALUES " .
    ...
    $sql = "INSERT INTO `[PREFIX]member` VALUES ".
           "('1', '[NAME]', 0, '0000-00-00', '', 0, 0, 0, '0', '0', '[TIME]', '0', '[TIME]', '1');";
    $sql = str_replace(
